...
namespace CgmInfoGui.Controls
{
    public class VisualCanvas : FrameworkElement
    {
        ...
        public static readonly DependencyProperty DirectionXProperty =
            DependencyProperty.Register("DirectionX", typeof(double), typeof(VisualCanvas), new PropertyMetadata(1.0));
        public static readonly DependencyProperty DirectionYProperty =
            DependencyProperty.Register("DirectionY", typeof(double), typeof(VisualCanvas), new PropertyMetadata(1.0));
